...
const achievements = [
    { id: '1', title: 'Muscle Power', image: require('./mp.jpg') },    // " you increased weight in an exercise!! ""
    { id: '2', title: 'Workout Star', image: require('./wkout.jpg') },    // five workouts completed or something
    { id: '3', title: 'Goal Setter', image: require('./gs.png') },
  ];
...
// function Save(goal, addGoal) {
//   console.log("New goal added:", goal);
//   addGoal(goal);
// }
 
// function CreateGoal({ addGoal }) {
//   const [goal, setGoal] = useState('');
